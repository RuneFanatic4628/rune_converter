    ...
    if EorD=='Encode':               #Encoding runes
        while rune_req=='types' :
            ...
            if rune_req=='types':
                ...
                print('+-----------------------+')
            if rune_req!='Anglo-Saxon Runes' or rune_req!='Elder Futhark Runes' or rune_req!='Younger Futhark Runes' or rune_req!='types':
    ...
    if EorD=='Decode':               #Decoding runes
        while rune_req=='types' :
            ...
            if rune_req=='types':
                ...
                print('| Younger Futhark Runes |')
                print('+-----------------------+')
            if rune_req!='Anglo-Saxon Runes' or 'Elder Futhark Runes' or 'Younger Futhark Runes' or 'types':
                print('That is not an available rune type. Please enter "types" to see a list of available rune types.')
